...
class _ToPayPageState extends State<ToPayPage>
  ...
  void initState() {
    ...
    _tabController.index = 0; // Set "To Pay" tab selected initially
    _fetchPendingOrders();
  }
  ...
  Future<void> _fetchPendingOrders() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${Config.baseUrl}/get_pending_orders.php?user_id=$userId'),
      );
      ...
      print('❌ Fetch pending orders failed: $e');
      setState(() => _loading = false);
    }
  }
