...
import 'package:final_ecommerce/models/book_product.dart';
import 'package:final_ecommerce/services/book_service.dart';
import '../config.dart';
...
class _BooksPageState extends State<BooksPage> {
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      padding: const EdgeInsets.only(
                        bottom: 16,
                      ), // ✅ Prevent scroll content overflow
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: FutureBuilder<List<BookProduct>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return PageView.builder(
                                  ...
                                  itemCount:
                                      books.length < 5 ? books.length : 5,
                                  itemBuilder: (context, index) {
                                    final book = books[index % books.length];
                                    final imageUrl =
                                        '${Config.imageBaseUrl}/${book.imagePath}';
  ...
  Widget _buildCategorySection(
    ...
    return FutureBuilder<List<BookProduct>>(
      future: BookService.fetchBooks(),
      builder: (context, snapshot) {
              ...
              Container(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final imageUrl = '${Config.imageBaseUrl}/${book.imagePath}';
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder:
                                (context) => ProductDetailsPage(
                                  ...
                                  storeName: book.author,
                                  quantitySold: book.quantitySold ?? 0,
                                  category: book.category,
                                ),
                          ),
                        );
