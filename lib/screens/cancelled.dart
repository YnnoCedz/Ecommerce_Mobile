...
class _CancelledPageState extends State<CancelledPage>
  ...
  void initState() {
    ...
    _tabController.index = 6; // Index for Cancelled
  ...
  Future<void> _fetchCancelledOrders() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${Config.baseUrl}/get_cancelled_orders.php?user_id=$userId'),
      );
      ...
      print('❌ Fetch cancelled orders failed: $e');
      setState(() => _loading = false);
    }
  }
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  Text(
                    'Status: ${order.orderStatus == 'cancel_requested' ? 'Cancel Requested' : 'Cancelled'}',
                    style: TextStyle(
                      color:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _buildCancelledOrdersList(),
